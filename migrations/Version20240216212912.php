 ...
 */
<<<<<<<< HEAD:migrations/Version20240216212912.php
final class Version20240216212912 extends AbstractMigration
========
final class Version20240228224212 extends AbstractMigration
>>>>>>>> acdf08a (ajout favori btn & products count + fix migrations & company et edit des vues):migrations/Version20240228224212.php
{
...
========
        $this->addSql('CREATE TABLE billing (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, users_id INT NOT NULL, status VARCHAR(25) NOT NULL, type VARCHAR(25) NOT NULL, emited_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', payment_method VARCHAR(25) DEFAULT NULL, discount NUMERIC(10, 0) DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_EC224CAA979B1AD6 (company_id), INDEX IDX_EC224CAA67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE billing_company_catalog (id INT AUTO_INCREMENT NOT NULL, billing_id INT NOT NULL, company_catalog_id INT NOT NULL, discount NUMERIC(10, 0) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_6EF3CB873B025C87 (billing_id), INDEX IDX_6EF3CB8771B28F6A (company_catalog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE company_catalog (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, product_id INT NOT NULL, margin NUMERIC(10, 0) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_3B7E2890979B1AD6 (company_id), INDEX IDX_3B7E28904584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
