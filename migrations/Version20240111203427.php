 ...
 */
final class Version20240111203427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billing_company_catalog (id INT AUTO_INCREMENT NOT NULL, billing_id INT NOT NULL, company_catalog_id INT NOT NULL, discount NUMERIC(10, 0) NOT NULL, INDEX IDX_6EF3CB873B025C87 (billing_id), INDEX IDX_6EF3CB8771B28F6A (company_catalog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
